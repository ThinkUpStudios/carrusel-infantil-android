...
/**
 * Created by dcamarro on 15/06/16.
 */
public abstract class DrawerAbstractActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_carruseles) {
            if(this.getContentView() != R.layout.mis_carruseles_drawer) {
